        ...
        <div className="flex items-center gap-x-4 lg:gap-x-6">
          ...
          <div className="hidden lg:flex items-center gap-x-4">
             ...
             <div className="flex flex-col">
               <span className="text-sm font-semibold text-foreground leading-none mb-1">{user?.name || 'University Rep'}</span>
               <span className="text-xs text-muted-foreground leading-none">University Portal</span>
             </div>
